package com.medallia.anywhere_versioning_sampleapp.network
...
interface RestClient {
    @POST
    suspend fun postFeedback(@HeaderMap headers: Map<String, String>, @Url endPoint: String,
                             @Body feedbackData: FeedbackData) : Response<JsonObject>
    @POST
